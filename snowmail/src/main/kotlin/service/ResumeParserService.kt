...
class ResumeParserService(private val openAIClient: OpenAIClient) {
...
suspend fun main() {
    ...
    val resumeParserController = ResumeParserService(openAIClient)
    ...
    runBlocking {
        val generatedEmail = openAIClient.generateEmail2(resumeText, "Google", "Software Engineer",  "John Doe")
        println("Generated Email Subject: ${generatedEmail.subject}")
        println("Generated Email Body: ${generatedEmail.body}")
    }
